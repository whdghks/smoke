...
(원통안에 물을 넣고 회전을 통하여 담배연기를 제거함 하지만 한 방향으로 회전할 경우 난류가 발생되지 않아 연기와 잘 섞이지가 않아서
세탁기 형식으로 하여서 난류를 발생시켜 담배연기를 섞이게 함)
>>* 담배연기 집진기는 1명에 담배연기를 기준으로 만들어야 함
>>* 다음주부터 졸작비가 나오는데 500만원정도 나오는데 4팀에서 같이 쓰는것이라 대략 한 팀당 130만원 사용가능
(재료를 사는데 가격적인 면은 걱정 안해도 됨)
